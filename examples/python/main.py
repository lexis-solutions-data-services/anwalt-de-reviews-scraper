"""
Example: How to call the anwalt-de-reviews-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/anwalt-de-reviews-scraper
...
def run_actor():
    """Run the anwalt-de-reviews-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/anwalt-de-reviews-scraper"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "startUrls": [{"url":"https://www.anwalt.de/benjamin-manhart"},{"url":"https://www.anwalt.de/onur-kent"}],
        }
    )
